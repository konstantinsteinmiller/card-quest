  ...
  campaignNodes.value = [
    {
      ...
      npcDeck: ['mermaid-young', 'moss-young', 'dragon-young', 'dragon-middle', 'piranha-young', 'mushroom-young', 'butterfly-middle', 'scorpion-young', 'warrior-young', 'shark-young', 'yeti-young'],
      position: { x: 18, y: 64 },
      unlocked: true,
      completed: isDebug.value ? true : false,
      unlocks: ['node1-2'],
      knownCards: [],
      rules: ['high', 'one']
    },
    ...
    },
    {
      ...
      npcDeck: ['asha-old', 'starlight-old', 'shark-middle', 'female-old', 'piranha-old', 'nightmare-middle', 'dragon-old', 'eclipse-old', 'snowman-old'],
      position: { x: 80, y: 20 },
      unlocked: false,
      completed: false,
      unlocks: [],
