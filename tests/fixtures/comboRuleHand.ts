...
export const createComboSameTestScenario = () => {
  board.value[1][0].card = {
    owner: 'npc', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
  ...
  board.value[2][1].card = {
    owner: 'npc', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
    image: modelImgPath('asha'), values: { top: 1, right: 1, bottom: 1, left: 3 }
  } as GameCard
  board.value[0][0].card = {
    owner: 'npc', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
    image: modelImgPath('asha'), values: { top: 1, right: 2, bottom: 1, left: 1 }
  } as GameCard // weaker than 8

  playerHand.value = [{
    owner: 'player', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
    image: modelImgPath('asha'),
...
export const createComboPlusTestScenario = () => {
  board.value[0][1].card = {
    owner: 'npc', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
    image: modelImgPath('asha'), values: { top: 9, right: 1, bottom: 5, left: 1 }
  } as GameCard
  // NPC card at Row 1, Col 0 (Left): Atk Left (4) + Card Right (6) = 10.
  board.value[1][0].card = {
    owner: 'npc', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
    image: modelImgPath('asha'), values: { top: 1, right: 6, bottom: 1, left: 1 }
  } as GameCard
  ...
  board.value[0][0].card = {
    owner: 'npc', id: 'asha', instanceId: Math.random().toString(36).substring(2, 11),
    name: 'Asha',
    image: modelImgPath('asha'), values: { top: 1, right: 1, bottom: 1, left: 1 }
  } as GameCard
